...
class MainActivity : ComponentActivity() {
    ...
    private val autoTuneLocationPermissionLauncher =
        ...
        // per-network key (the cache lookup treats a missing grant as a null key).
        registerForActivityResult(ActivityResultContracts.RequestPermission()) { desyncVm.runAutoTune() }
